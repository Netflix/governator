 ...
 */
public class DefaultClasspathScanner extends ClasspathScanner
{
     ...
     */
    public DefaultClasspathScanner(Collection<String> basePackages, Collection<Class<? extends Annotation>> annotations)
    {
     ...
     */
    public DefaultClasspathScanner(Collection<String> basePackages, Collection<Class<? extends Annotation>> annotations, final ClassLoader classLoader) 
    {
