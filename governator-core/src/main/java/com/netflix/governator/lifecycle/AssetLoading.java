...
class AssetLoading
{
    ...
    public boolean     loadAssetsFor(Object obj, Collection<AssetLoader> assetLoaders) throws Exception
    {
    ...
    private void internalLoadAsset(RequiredAsset requiredAsset, Object obj, Collection<AssetLoader> assetLoaders) throws Exception
    {
        AssetLoader             loader = null;
        for ( AssetLoader checkLoader : assetLoaders )
        {
            if ( checkLoader.appliesTo(obj, requiredAsset.value()) )
            {
                loader = checkLoader;
                break;
            }
