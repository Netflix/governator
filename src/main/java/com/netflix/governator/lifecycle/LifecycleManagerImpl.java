...
public class LifecycleManagerImpl implements LifecycleManager {
    ...
    public LifecycleManagerImpl(LifecycleManagerArguments arguments)
    {
        this(arguments, null);
    }

    @Inject
    public LifecycleManagerImpl(LifecycleManagerArguments arguments, Injector injector)
    {
    ...
    private WarmUpDriver getWarmUpDriver()
    {
        return new WarmUpDriver()
        {
            ...
            {
                LifecycleManagerImpl.this.setState(obj, state);
            }
        };
    }
